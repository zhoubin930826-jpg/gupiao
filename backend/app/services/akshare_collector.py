...
class AkshareCollector:
    ...
    def collect_market_dataset(
        ...
        *,
        ...
        benchmark_records = collect_market_benchmark_records(ak=ak)
        breadth_snapshot = build_market_breadth_from_spot_frame(spot_frame)
        market_capital_flow, lhb_rows = collect_market_capital_flow_bundle(ak=ak, market=DEFAULT_MARKET_SCOPE)
    ...
    def _select_candidates(
        ...
        *,
        ...
        min_turnover = _effective_min_turnover(market, strategy.min_turnover)
    ...
    def _collect_histories(
        ...
        *,
        ...
        max_workers = max(1, self.settings.akshare_max_workers)
